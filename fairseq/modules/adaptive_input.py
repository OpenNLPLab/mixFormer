...
class AdaptiveInput(nn.Module):
    ...
    def _sample_parameters(self):
        # weights = []
        # for i in range(len(self.cutoff)):
        #     weight = seq = nn.Sequential(
        #         self.embeddings[i][0].weight[..., :self.sample_embed_dim],
        #         self.embeddings[i][1].weight[..., :self.sample_embed_dim]
        #     )
        #     weights.append(weight)
        # self.samples['weight'] = weights
    ...
    def calc_sampled_param_num(self, config=None):
